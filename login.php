...
<section class="w3l-inner-banner-main">
    <div class="about-inner contact ">
        <div class="container">   
            ...
            <h3 class="header-name " style="color:#d4af37;">
                Login Page
            </h3>
        </div>
</div>
...
?>
                    <div class="cont-top">
                        ...
                        <h6 style="color:#d4af37;">Call Us</h6>
                    ...
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                        <h6 style="color:#d4af37;">Email Us</h6>
                    ...
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                        <h6 style="color:#d4af37;">Address</h6>
                ...
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        ...
                        <div class="twice-two" style="padding-top: 30px;">
                          ...
                          <a class="link--gray" style="color: blue;" href="signup.php">Sign Up</a>
